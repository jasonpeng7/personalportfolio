...
export function SparklesPreviewPROJECT() {
  return (
    <div className="min-h-52 relative w-full flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <h1 className="z-20 red-hat-extrabold text-center sm:text-left text-5xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-7xl font-bold text-dark_navy z-20 max-w-full break-words leading-tight">
        Projects.
      </h1>
    </div>
  );
