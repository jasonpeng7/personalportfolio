...
export const ContainerScroll = ({ titleComponent, children }) => {
  ...
  return (
    <div ref={containerRef} className="relative h-[200vh] flex items-center justify-center p-2 md:p-20"> {/* Ensure enough height for scrolling */}
...
// Header and Card components remain unchanged...
